...
The key idea underpinning our approach is that data points are embedded
...
Additional experiments with embedding secondary datasets from independent
...
Our procedure and the resulting cell landscape are affectected by the asymmetry
of determining the reference and the secondary datasets. In practice, however,
newly produced \em secondary \em datasets would be embedded into published and
annnotated the reference landscapes. Scaling-up to a wider collection of cell
